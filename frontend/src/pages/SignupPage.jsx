...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols p-4">
      {/* left side */}
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 ">
        <div className="w-full max-w-md space-y-5 bg-base-content/5 shadow-2xl p-3 rounded-2xl">
          {/* LOGO */}
          ...
          <a
            href="https://chatapp-abhi.up.railway.app/api/auth/google?mode=signup"
